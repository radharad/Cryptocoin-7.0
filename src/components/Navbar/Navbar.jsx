...
export default function Navbar() {
  ...
  return (
     <div className='color bg-transparent text-white mx-auto overflow-hidden'>
      <div>
        ...
        <button className='w-[150px]  border-2 border-white p-2 rounded-[23px] '> Get Started </button>
        </ul>
        ...
        <button className='w-[200px] border border-white p-2 rounded-[23px] '> Get Started </button>
        </ul>
      </div> 
      </div>
     </div>
